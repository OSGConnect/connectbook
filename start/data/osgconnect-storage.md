...
|      :---------:       |        :------:      |       :-----:     |     :--------:     |     :------:     |
|      **HTCondor File Transfer**      |         < 1 GB       |      `/home`      |  HTCondor default output transfer or `transfer_output_files` | [HTCondor Transfer](https://support.opensciencegrid.org/support/solutions/articles/5000639787)|
|     **StashCache**     |  >1GB and<br>< 10 GB |      `/public`    |      `stashcp` in job executable    |   [StashCache](https://support.opensciencegrid.org/support/solutions/articles/12000002775) |
|       **GridFTP**      |        > 10 GB       |      `/public`    |     `gfal-copy`    | [contact us](mailto:support@opensciencegrid.org) |
