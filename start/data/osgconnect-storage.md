...
| **OSG's<br> transfer tools** | >1GB;<br><10 GB per job | `/public` | `stash` address in `transfer_input_files` | [StashCache](https://support.opensciencegrid.org/support/solutions/articles/12000002775)|
...
|     **OSG's transfer tools**     |  >1GB and<br>< 10 GB |      `/public`    |      `stashcp` in job executable    |   [StashCache](https://support.opensciencegrid.org/support/solutions/articles/12000002775) |
