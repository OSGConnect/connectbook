...
in the OS Pool.  You can use your own custom container to run jobs in the 
OS Pool, and we assume that those containers are built using Docker.  This 
...
1. Use one of the base containers provided by the OS Pool
...
Singularity image in the OS Pool. [Email us](mailto:support@opensciencegrid.org) if you would like 
