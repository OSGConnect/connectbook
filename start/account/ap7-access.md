---
    title: Accessing ap7.ospool.osg-htc.org
...
* applying for an `ap7.ospool.osg-htc.org` account 
* meeting with a OSG staff member for a short orientation
...
## Request Access to `ap7.ospool.osg-htc.org`
...
1. Open a terminal and type `ssh username@submit6.chtc.wisc.edu`, being sure to replace `username` with your `ap7.ospool.osg-htc.org` username. Upon hitting enter, the following text should appear with a unique, but similar, URL: 
