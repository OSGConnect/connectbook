...
This guide will show you two examples of how to run jobs that use Python in the OS Pool.
...
## Running Base Python on the OS Pool
Several installations of base Python are available via the [OS Pool's Software 
Module System][module-guide]. To see what Python versions are available on the OS Pool
